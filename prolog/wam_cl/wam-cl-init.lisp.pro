...
*/
/*
:- side_effect(assert_lsp(psetf, init_args(0, cl_psetf))).
*/
/*
...
*/
/*
:- side_effect(assert_lsp(shiftf, init_args(0, cl_shiftf))).
*/
/*
...
:- side_effect(assert_lsp(rotatef,
			  lambda_def(defmacro,
				     rotatef,
				     cl_rotatef,
				     [c38_rest, sys_places, c38_environment, env],
...
*/
/*
:- side_effect(assert_lsp(rotatef, init_args(0, cl_rotatef))).
*/
/*
; Adapted from SBCL.
*/
...
:- side_effect(assert_lsp(push,
			  lambda_def(defmacro,
				     push,
				     cl_push,
				     [c38_environment, env, item, sys_place],
					 ...
					 [ multiple_value_bind,
					   ...
					   [get_setf_expansion, sys_place, env],
...
*/
/*
:- side_effect(assert_lsp(push, init_args(2, cl_push))).
*/
/*
; Adapted from SBCL.
*/
...
*/
/*
:- side_effect(assert_lsp(pushnew, init_args(2, cl_pushnew))).
*/
/*
; Adapted from SBCL.
*/
...
*/
/*
:- side_effect(assert_lsp(pop, init_args(1, cl_pop))).
*/
/*
