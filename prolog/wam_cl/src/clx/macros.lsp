  ...
  ((index string &key buffer (start 0) end header-length appending)
   ...
   (let* ((real-end (if appending (or end `(length ,string)) (gensym)))
	 ...
	 form
	  ...
	  #+ecl (declare (type array-index ,real-end))
		 ...
		 (if (atom form)
		   ...
		   (prog1
			...
			,form)
		     (incf bit))))
	     (get-put-items
	       (#-ecl + #+ecl index+ index 4) type-values nil
