...
%; Start time: Sun Jan 28 04:12:09 2018
...
*/
/*
% conds:-[[[eq,_203826,[quote,0]],[progn,[list,[quote,car],sys_v]]],[[eq,_203826,[quote,1]],[progn,[list,[quote,cadr],sys_v]]],[[eq,_203826,[quote,2]],[progn,[list,[quote,caddr],sys_v]]],[[eq,_203826,[quote,3]],[progn,[list,[quote,cadddr],sys_v]]]].
*/
/*
:- side_effect(generate_function_or_macro_name([name='GLOBAL', environ=env_1],
					       sys_dm_nth_cdr,
...
*/
/*
% conds:-[[[eq,_208472,[quote,0]],[progn,sys_v]],[[eq,_208472,[quote,1]],[progn,[list,[quote,cdr],sys_v]]],[[eq,_208472,[quote,2]],[progn,[list,[quote,cddr],sys_v]]],[[eq,_208472,[quote,3]],[progn,[list,[quote,cdddr],sys_v]]]].
*/
/*
:- side_effect(generate_function_or_macro_name(
					       [ fbound(sys_dm_nth_cdr, kw_function)=function(f_sys_dm_nth_cdr1),
						 fbound(sys_dm_nth, kw_function)=function(f_sys_dm_nth1),
						 fbound(sys_dm_v, kw_function)=function(f_sys_dm_v1),
						 fbound(sys_dm_vl, kw_function)=function(f_sys_dm_vl1),
						 name='GLOBAL',
						 environ=env_1
					       ],
					       sys_find_doc,
...
f_sys_expand_defmacro(Name_In, Vl_In, Body_In, RestNKeys, FnResult) :-
	...
	aux_var(Env, sys_envp, Envp_In, true, []),
		  ...
		  assert_lsp(sys_dm_nth,
			     wl:lambda_def(defun, sys_dm_nth, f_sys_dm_nth1, [sys_n, sys_v], [[multiple_value_bind, [sys_q, sys_r], [floor, sys_n, 4], [declare, [fixnum, sys_q, sys_r]], [dotimes, [sys_i, sys_q], [setq, sys_v, [list, [quote, cddddr], sys_v]]], [case, sys_r, [0, [list, [quote, car], sys_v]], [1, [list, [quote, cadr], sys_v]], [2, [list, [quote, caddr], sys_v]], [3, [list, [quote, cadddr], sys_v]]]]])),
		  assert_lsp(sys_dm_nth,
			     wl:arglist_info(sys_dm_nth, f_sys_dm_nth1, [sys_n, sys_v], arginfo{all:[sys_n, sys_v], allow_other_keys:0, aux:0, body:0, complex:0, env:0, key:0, names:[sys_n, sys_v], opt:0, req:[sys_n, sys_v], rest:0, sublists:0, whole:0})),
		  assert_lsp(sys_dm_nth, wl:init_args(2, f_sys_dm_nth1)),
		  assert_lsp(sys_dm_nth,
		  ...
		  assert_lsp(sys_dm_nth_cdr,
			     wl:lambda_def(defun, sys_dm_nth_cdr, f_sys_dm_nth_cdr1, [sys_n, sys_v], [[multiple_value_bind, [sys_q, sys_r], [floor, sys_n, 4], [declare, [fixnum, sys_q, sys_r]], [dotimes, [sys_i, sys_q], [setq, sys_v, [list, [quote, cddddr], sys_v]]], [case, sys_r, [0, sys_v], [1, [list, [quote, cdr], sys_v]], [2, [list, [quote, cddr], sys_v]], [3, [list, [quote, cdddr], sys_v]]]]])),
		  assert_lsp(sys_dm_nth_cdr,
			     wl:arglist_info(sys_dm_nth_cdr, f_sys_dm_nth_cdr1, [sys_n, sys_v], arginfo{all:[sys_n, sys_v], allow_other_keys:0, aux:0, body:0, complex:0, env:0, key:0, names:[sys_n, sys_v], opt:0, req:[sys_n, sys_v], rest:0, sublists:0, whole:0})),
		  assert_lsp(sys_dm_nth_cdr, wl:init_args(2, f_sys_dm_nth_cdr1)),
		  assert_lsp(sys_dm_nth_cdr,
		  ...
		  f_sys_dm_vl1(Vl_Get608, Whole_Get609, t, T),
...
%; Total compilation time: 14.917 seconds
